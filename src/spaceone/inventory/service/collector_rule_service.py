...
class CollectorRuleService(BaseService):
    ...
    def create(self, params):
        ...
        params["order"] = (
            self._get_highest_order(collector_id, rule_type, domain_id) + 1
        )
    ...
    def change_order(self, params):
        ...
        target_collector_rule_vo: CollectorRule = (
            self.collector_rule_mgr.get_collector_rule(collector_rule_id, domain_id)
        )
        ...
        highest_order = self._get_highest_order(
            target_collector_rule_vo.collector_id,
        ...
        return self.collector_rule_mgr.update_collector_rule_by_vo(
            {"order": order}, target_collector_rule_vo
        )
    ...
    def get(self, params):
        ...
        return self.collector_rule_mgr.get_collector_rule(
            collector_rule_id, domain_id, params.get("only")
        )
    ...
    def _get_all_collector_rules(
        self, collector_id, rule_type, domain_id, exclude_collector_rule_id=None
    ):
        query = {
            "filter": [
