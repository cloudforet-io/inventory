...
class CollectorRuleManager(BaseManager):
    ...
    def change_cloud_service_data(self, cloud_service_data):
        collector_id = cloud_service_data['collector_id']
    ...
    def _change_cloud_service_data_with_actions(self, cloud_service_data, actions, domain_id):
        for action, value in actions.items():
            ...
            if action == 'add_additional_info':
                cloud_service_data['additional_info'] = cloud_service_data.get('additional_info', {})
                cloud_service_data['additional_info'].update(value)
